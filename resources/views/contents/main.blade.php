...
<section class="content">
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            @include("widgets.smallbox.aqua.bag", ["color" => "aqua", "icon" => "ion-bag","data" => 150, "desc" => "New Orders", "link"  => "http://m.baidu.com"])
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            @include("widgets.smallbox.basic", ["color" => "green", "icon" => "ion-stats-bars","data" => '53<sup style="font-size: 20px">%</sup>', "desc" => "Bounce Rate", "link"  => "http://m.baidu.com"])
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
